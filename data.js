...
const areas=[
 {id:'toll-tower',name:'Mýtná věž',short:'Věž',scene:0,x:48,y:62,level:1,material:'Mýtné pečeti',boss:'Výběrčí poslední mince',bossArt:3,focus:['relic','ring','offhand'],hint:'Zvon svolává stráže. Někdo uvnitř ví, jak ho umlčet.',quest:'Zruš mýto pro živé i zesnulé.',recipe:'amulet'},
 {id:'whisperwood',name:'Šeptající les',short:'Les',scene:1,x:28,y:52,level:3,material:'Lesní runy',boss:'Jelen bludných cest',bossArt:5,focus:['weapon','feet','ring'],hint:'Jelena léčí kořeny propojené s hájem. Cestou můžeš toto spojení přetnout.',quest:'Poraž zakletého strážce háje a otevři pocestným cestu z lesa.',recipe:'dagger'},
 {id:'black-mine',name:'Černý důl',short:'Důl',scene:2,x:77,y:44,level:5,material:'Černá ruda',boss:'Předák poslední směny',bossArt:0,focus:['body','offhand','head','hands'],hint:'Předákovu zbroj pokrývá černá ruda. Úspěšné přerušení jeho těžkého útoku tento krunýř rozbije.',quest:'Ukonči směnu, která trvá už třicet let.',recipe:'shield'},
 {id:'stolen-hours-cave',name:'Jeskyně zadržených hodin',short:'Jeskyně',scene:5,x:83,y:27,level:7,material:'Časové krystaly',boss:'Velký Časomol',bossArt:4,focus:['relic','ring','weapon'],hint:'Časomol vrací část síly tvých úderů jako ozvěnu. Rozladěné krystaly ji umlčí.',quest:'Vrať ukradené večery jejich majitelům.',recipe:'amulet'},
 {id:'overtime-castle',name:'Hrad Přesčas',short:'Hrad',scene:3,x:66,y:16,level:9,material:'Královské erby',boss:'Král Přesčas I.',bossArt:3,focus:['weapon','relic','body'],hint:'Král vybírá daň z každého slabého úderu. Šetři sílu na finále.',quest:'Vrať poddaným jejich vlastní večery.',recipe:'axe'},
 {id:'expectation-peaks',name:'Hory očekávání',short:'Hory',scene:4,x:30,y:8,level:12,material:'Hvězdné úlomky',boss:'Strážce nesplnitelných slibů',bossArt:5,focus:['relic','ring','weapon'],hint:'Lavina nezajímá, kolik máš zkušeností. Rozhoduje příprava.',quest:'Přines důkaz, že i nemožný úkol má konec.',recipe:'amulet'}
];
const foeKinds={
