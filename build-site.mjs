...
for (const entry of ['index.html', 'styles.css', 'mobile-scene.css', 'character.css', 'data.js', 'encounters.js', 'story.js', 'engine.js', 'audio.js', 'scenes.js', 'saves.js', 'game.js']) {
  await cp(new URL(`./${entry}`, import.meta.url), new URL(`./${entry}`, output), { recursive:true });
}
await mkdir(new URL('./assets/', output), {recursive:true});
for (const asset of ['overworld-v3.webp', 'characters-v3.webp', 'environments-v3.webp', 'sir-smik.webp','equipment-atlas-v1.webp','equipment-atlas-v2.webp','equipment-atlas-v3.webp','encounter-characters.png','encounter-props.png']) {
