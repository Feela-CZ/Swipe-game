...
const areas=[
 ...
 {id:'overtime-castle',name:'Hrad Přesčas',short:'Hrad',scene:3,x:66,y:16,level:8,material:'Královské erby',boss:'Král Přesčas I.',bossArt:3,focus:['weapon','relic','body'],hint:'Král vybírá daň z každého slabého úderu. Šetři sílu na finále.',quest:'Vrať poddaným jejich vlastní večery.',recipe:'axe'},
 {id:'expectation-peaks',name:'Hory očekávání',short:'Hory',scene:4,x:30,y:8,level:11,material:'Hvězdné úlomky',boss:'Strážce nesplnitelných slibů',bossArt:5,focus:['relic','ring','weapon'],hint:'Lavina nezajímá, kolik máš zkušeností. Rozhoduje příprava.',quest:'Přines důkaz, že i nemožný úkol má konec.',recipe:'amulet'}
];
const foeKinds={
